...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.cart = function () {
  var cart = [];
  var arr = [];
  var total = Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('.cart-pay-last');
...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('.features-d').cart();

/***/ }),

/***/ "./src/js/lib/components/menu.js":
/*!***************************************!*\
  !*** ./src/js/lib/components/menu.js ***!
  \***************************************/
/*! no exports provided */
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.hamburger = function () {
  var hamburger = Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('.hamburger-toggle');
...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('.hamburger-toggle').hamburger();
...
window.$ = $;
/* harmony default export */ __webpack_exports__["default"] = ($); // chnayac  window-ov globalarcel enq bayc qani vor arandzin
...
/* harmony import */ var _components_tabs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/tabs */ "./src/js/lib/components/tabs.js");
...
/* harmony import */ var _components_cart__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/cart */ "./src/js/lib/components/cart.js");
/* harmony import */ var _components_menu__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/menu */ "./src/js/lib/components/menu.js");
 //import anenq  $-funkcian
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.siblings = function (selector) {
  let numberOfItem = 0;
  let counter = 0;
  const copyObj = Object.assign({}, this);
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.toggleClass = function (classNames) {
  for (let i = 0; i < this.length; i++) {
    this[i].classList.toggle(classNames); // stex miacnum enq mek klass
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_libs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/libs */ "./src/js/lib/libs.js");
